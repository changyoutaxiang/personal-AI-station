  ...
  return (
    <div className="relative w-full mx-auto">
      ...
      <div id="poda" className="relative w-full group">
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[80px] rounded-xl blur-[3px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[85px] rounded-xl blur-[3px] 
                        before:absolute before:content-[''] before:z-[-2] before:w-[600px] before:h-[600px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[82deg]
                        before:bg-[conic-gradient(rgba(0,0,0,0),#18116a,rgba(0,0,0,0)_10%,rgba(0,0,0,0)_50%,#6e1b60,rgba(0,0,0,0)_60%)] before:transition-all before:duration-2000
                        group-hover:before:rotate-[-98deg] group-focus-within:before:rotate-[442deg] group-focus-within:before:duration-[4000ms]">
        </div>
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[78px] rounded-lg blur-[2px] 
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[74px] rounded-xl blur-[0.5px] 
        ...
        <div id="main" className="relative w-full group">
          <input 
            ...
            type="text" 
            name="text" 
            className="bg-[#010201] border-none w-full h-[71px] rounded-lg text-white px-[60px] text-lg focus:outline-none placeholder-gray-400" 
          />
          <div id="input-mask" className="pointer-events-none w-[80px] h-[20px] absolute bg-gradient-to-r from-transparent to-black top-[25px] left-[70px] group-focus-within:hidden"></div>
          <div id="pink-mask" className="pointer-events-none w-[30px] h-[20px] absolute bg-[#cf30aa] top-[17px] left-[5px] blur-2xl opacity-80 transition-all duration-2000 group-hover:opacity-0"></div>

          <div id="search-icon" className="absolute left-[20px] top-[24px]">
